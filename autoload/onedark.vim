...
let s:colors = {
      ...
      \ "green": get(s:overrides, "green", { "gui": "#00AF87", "cterm": "36", "cterm16": "2" }),
      ...
      \ "blue": get(s:overrides, "blue", { "gui": "#5F87D7", "cterm": "68", "cterm16": "4" }),
      \ "purple": get(s:overrides, "purple", { "gui": "#AF87D7", "cterm": "140", "cterm16": "5" }),
      ...
      \ "comment_grey": get(s:overrides, "comment_grey", { "gui": "#008787", "cterm": "30", "cterm16": "15" }),
      ...
      \ "visual_grey": get(s:overrides, "visual_grey", { "gui": "#585858", "cterm": "240", "cterm16": "15" }),
